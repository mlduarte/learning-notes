...
ggplot(data.frame(observed, predicted), aes(observed, predicted)) + 
  geom_point() + 
  expand_limits(
    x =  min(observed, predicted),
    x =  max(observed, predicted),
    y = min(observed, predicted), 
    y = max(observed, predicted)) + 
