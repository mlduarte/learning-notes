...
2. Feature exraction algorithms (e.g. PCA) can also be used to mitigate effect of correlations; the disadvantage is that they make connection between predictors more complex and as unsupervised no gurantee that resulting components will have relationship with outcome. 
...
```{r bloodBrain_trim_for_anneal_and_genetic}
require(subselect)
ncol(bbb_cor_raw)
